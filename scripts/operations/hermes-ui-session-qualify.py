...
INPUTS={'e2e-readonly-observer.py': 'a34fb86bbf078d4634106c2a9cc390267909a4a58a4d5485b5db306879c66762', 'hermes-ui-session-seal.mjs': '97a84fe61e74a5ef2b4145454f4ca53634e0ac923fd3b04d986e5f7c71adb321', 'hermes-ui-session-start.mjs': '417c60f4f2a95710c645e5b0db07ce05b1dd7b6b1e2bcafcbf7d87fc29d990a7', 'probe-protected-runtime.mjs': '8d3c6cc8270dc79d14c1fb97988f1f0dcba97572b623ca49e6cbe1233b92d4de'}
...
def run_user(name,phase,args,env=None,signer_view=False):
 ...
 cmd=['systemd-run','--quiet','--wait','--pipe','--collect','--unit=himawari-ui-session-qualify-'+phase]
...
def main():
 ...
 manifest=json.loads((B/'himawari-ui-session-source.json').read_text())
 assert manifest['archiveSha256']=='601e6dad9fdb882b876a662d6df91da5e692c410ddf33edc128f5c5010c9741b'
 ...
 try:
  ...
  signer=run_user('andy','signer-preflight',[RUNTIME/'pi-tools/bin/node',Q/'hermes-ui-session-seal.mjs','--preflight'],signer_view=True)
  ...
  result=run_user('andy','seal',[RUNTIME/'pi-tools/bin/node',Q/'hermes-ui-session-seal.mjs'],signer_view=True)
...
if __name__=='__main__':
 ...
 fd=os.open('/run/himawari-ui-session-qualification.lock',os.O_CREAT|os.O_RDWR|os.O_NOFOLLOW,0o600)
