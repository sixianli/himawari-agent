...
const root = "/data/hermes/himawari",
  ...
  q = root + "/qualifications/2026-09-11-native-history-installation/seal-stage";
process.umask(0o077);
...
for (const p of [
  ...
  qualificationSources[p] = await fileHash(
    root + "/qualifications/2026-09-11-native-history-installation/probe-source/" + p,
  );
const receipt = {
  ...
  source: JSON.parse(
    await readFile(
      root + "/builds/2026-09-11-native-history/himawari-native-history-source.json",
      "utf8",
    ),
  ),
};
