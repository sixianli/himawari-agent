...
W=R/'qualifications/2026-09-13-source-links-cutover'
CURRENT=R/'releases/2026-09-11-control-center'
CANDIDATE=R/'releases/2026-09-13-source-links'
ARCHIVE=R/'releases/2026-09-13-before-source-links'
...
BACKUP_ID='before-source-links-2026-09-13'
ATTESTATION=STATE/'deployment/startup-attestation.json'
OLD_START=R/'qualifications/2026-09-13-search-time-installation/hermes-search-time-start.mjs'
EXPECTED_RECEIPT=sys.argv[3] if len(sys.argv)==4 and sys.argv[1:3]==['--apply','--receipt'] else ''
EXPECTED_CURRENT_RUNTIME='a9b48f6731f4087feff92f000c98f2436245ca580569708d8f585f4d848c307d'
INPUTS={'hermes-protected-registered.mjs': '7904085d39a50e3d2bbab9547ed2e230cc96a9d2592556d8bb5db722b8f6aaa8', 'hermes-source-links-web-probe.mjs': '40bd188d2cb8560817ad665277e435c5abce442f3bcb2783943f31470a3bc510'}
...
def invoke(phase,args,candidate_view=False,protected=True):
 ...
 cmd=['systemd-run','--quiet','--wait','--pipe','--collect','--unit=himawari-source-links-cutover-'+phase]
...
def main():
 ...
 assert sha(Q/'hermes-source-links-start.mjs')=='bb2df0c1ec1b2d990eb3db00b74440c24e1982eb7e477a5a674dfaad309ee467'
 ...
 try:
  ...
  web=invoke('web-static',[node,W/'hermes-source-links-web-probe.mjs'],True)
  ...
  startup=invoke('prepare',[node,Q/'hermes-source-links-start.mjs','--prepare',prepared],True);assert startup['preparing'];assert startup['runtimeDigest']==qualified['runtimeDigest']
  ...
  next_unit=UNIT.with_name('himawari.service.harness-next');next_unit.write_text(original_unit.replace(old_exec,'ExecStart='+str(node)+' '+str(Q/'hermes-source-links-start.mjs')));next_unit.chmod(0o644);os.replace(next_unit,UNIT)
