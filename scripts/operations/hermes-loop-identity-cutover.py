...
B=R/'builds/2026-09-13-loop-identity'
Q=R/'qualifications/2026-09-13-loop-identity-installation'
W=R/'qualifications/2026-09-13-loop-identity-cutover'
CURRENT=R/'releases/2026-09-11-control-center'
CANDIDATE=R/'releases/2026-09-13-loop-identity'
ARCHIVE=R/'releases/2026-09-13-before-loop-identity'
...
CANDIDATE_AUTH=pathlib.Path('/etc/himawari/loop-identity-candidate.json')
BACKUP_ID='before-loop-identity-2026-09-13'
ATTESTATION=STATE/'deployment/startup-attestation.json'
OLD_START=R/'qualifications/2026-09-13-loop-finalization-installation/hermes-loop-finalization-start.mjs'
EXPECTED_RECEIPT=sys.argv[3] if len(sys.argv)==4 and sys.argv[1:3]==['--apply','--receipt'] else ''
EXPECTED_CURRENT_RUNTIME='7b05555bbb12cb281d182c3c91d809f40b1dad2ac6c0e466799a051d2ffe57bd'
INPUTS={'hermes-protected-registered.mjs': '7904085d39a50e3d2bbab9547ed2e230cc96a9d2592556d8bb5db722b8f6aaa8', 'hermes-harness-web-probe.mjs': 'f1bac69509ce6e06460978a603412ef6b2b7376c89021413557383ac2c099b5b'}
...
def invoke(phase,args,candidate_view=False,protected=True):
 ...
 cmd=['systemd-run','--quiet','--wait','--pipe','--collect','--unit=himawari-loop-identity-cutover-'+phase]
...
def main():
 ...
 assert sha(Q/'hermes-loop-identity-start.mjs')=='4e058cb50e18be3a55508b40615b8b9c1b7b86aa3d1255b9983dcc651c9b41f0'
 ...
 try:
  ...
  startup=invoke('prepare',[node,Q/'hermes-loop-identity-start.mjs','--prepare',prepared],True);assert startup['preparing'];assert startup['runtimeDigest']==qualified['runtimeDigest']
  ...
  next_unit=UNIT.with_name('himawari.service.harness-next');next_unit.write_text(original_unit.replace(old_exec,'ExecStart='+str(node)+' '+str(Q/'hermes-loop-identity-start.mjs')));next_unit.chmod(0o644);os.replace(next_unit,UNIT)
