...
SCRIPT=pathlib.Path(__file__).resolve().parents[4]/'scripts/operations/hermes-ui-session-cutover.py'
class CutoverTest(unittest.TestCase):
 def scenario(self,fail=None):
  ...
  with tempfile.TemporaryDirectory(prefix='himawari-cutover-test-') as d:
   ...
   startup=m.Q/'hermes-ui-session-start.mjs';startup.write_text('fixture startup')
   ...
   def sha(p):return '417c60f4f2a95710c645e5b0db07ce05b1dd7b6b1e2bcafcbf7d87fc29d990a7' if p==startup else realsha(p)
