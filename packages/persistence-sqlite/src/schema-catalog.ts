...
export const schemaCatalog: readonly SchemaCatalogEntry[] = Object.freeze([
  ...
  entry(
    ...
    "immutable Fork snapshot and non-content lineage marker",
    "metadata_only",
    "retain marker while removing source content resolution",
  ),
  entry(
    "thread_command_receipts",
    "ThreadRepositoryPort",
    "immutable idempotent command receipt",
    "payload_reference",
  ...
  entry(
    ...
    "metadata_only",
    "delete immediately with Message or Thread and rebuild from authorized inputs",
  ),
  entry(
    "thread_title_search_projection",
    "ThreadRepositoryPort",
    "rebuildable opaque-token title projection",
    "metadata_only",
    "delete immediately with Thread and rebuild only at the current title revision",
  ),
  entry(
    "devices",
  ...
  entry(
    "run_coordination_checkpoints",
    "RunCheckpointStore",
    "revision-checked current runtime checkpoint",
    "payload_reference",
    "cascade with Run deletion",
  ),
  entry(
    "run_coordination_worker_results",
    "RunCheckpointStore",
    "replaceable worker result references",
    "payload_reference",
  ...
  entry(
    "thread_checkpoint_sources",
    "ThreadDistillationStatePort",
    "immutable checkpoint source slice",
    "metadata_only",
  ...
  entry(
    "thread_summaries",
    "ThreadDistillationStatePort",
    "immutable completed generation summary",
    "payload_reference",
    "cascade with generation deletion",
  ),
  entry(
    "thread_derivative_candidates",
    "ThreadDistillationStatePort",
    "immutable generation candidate",
    "payload_reference",
    "cascade with generation deletion",
  ),
  entry(
    "thread_derivative_provenance",
    "ThreadDistillationStatePort",
    "immutable candidate source relationship",
    "metadata_only",
    "cascade with derivative candidate deletion",
  ),
  entry(
    "memory_records",
