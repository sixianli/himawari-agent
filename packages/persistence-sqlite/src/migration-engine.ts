...
const bundledMigrationFiles = [
  ...
  {
    sequence: 14,
    name: "governed_authorization_and_github_history",
    changeSet: "governed-authorization-and-github-history",
    phase: "expand" as const,
  ...
  {
    sequence: 18,
    name: "run_coordination_checkpoints",
    changeSet: "run-coordination-checkpoints",
    phase: "contract" as const,
    file: "0018_run_coordination_checkpoints.sql",
  },
  {
    sequence: 19,
    name: "run_payload_artifacts",
    changeSet: "run-payload-artifacts",
    phase: "contract" as const,
    file: "0019_run_payload_artifacts.sql",
  },
  {
    sequence: 20,
    name: "capability_invocation_receipts",
    changeSet: "capability-invocation-receipts",
    phase: "contract" as const,
  ...
  {
    sequence: 22,
    name: "model_budget_ledger",
    changeSet: "model-budget-ledger",
    phase: "contract" as const,
    file: "0022_model_budget_ledger.sql",
  },
  {
    sequence: 23,
    name: "model_invocation_identities",
    changeSet: "model-invocation-identities",
    phase: "contract" as const,
  ...
  {
    sequence: 28,
    name: "sandbox_execution_resources",
    changeSet: "sandbox-execution-resources",
    phase: "contract" as const,
    file: "0028_sandbox_execution_resources.sql",
  },
  {
    sequence: 29,
    name: "sandbox_execution_preparation",
    changeSet: "sandbox-execution-preparation",
    phase: "contract" as const,
